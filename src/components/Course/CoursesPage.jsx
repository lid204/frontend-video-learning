...
function CoursesPage({ onBackToHome, onViewCourse, initialSearchQuery = '' }) {
  ...
  const filteredCourses = courses.filter((course) => {
    ...
    const matchCategory =
      activeCategory === 'Tất cả' || categoryName === activeCategory;
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          <div style={{ marginBottom: '20px', color: '#64748b' }}>
            Đang hiển thị{' '}
            <b style={{ color: '#0f172a' }}>{filteredCourses.length}</b> khóa học
          </div>
